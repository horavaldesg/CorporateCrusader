...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        {
            OrientationManager.OnOrientationChange += Refresh;
        }
        ...
        void Refresh (ScreenOrientation orientation)
        {
            //ToggleRefresh(false);
                ...
                || Screen.orientation != LastOrientation)
            {
                ...
                Debug.Log("New Screen Orientation " + Screen.orientation);
